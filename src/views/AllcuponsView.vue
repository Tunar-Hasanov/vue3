...
<template>
  <div class="w-full min-h-[100vh]">
    ...
    <wp_component />
    <div
      class="w-full h-[40vh] bg-[url('https://images.unsplash.com/photo-1578034756435-4b92079f4c21?q=80&w=1522&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-cover bg-center"
    ></div>
    <div class="w-full p-2">
      <h1 class="text-2xl font-bold">Bütün Kuponlar</h1>
    ...
    <div class="w-full p-6 flex bg-second flex-wrap justify-around">
      <!-- card Item start -->
      <div v-for="item in kupon"
      :key="item._id" class="w-[450px] shadow-lg border border-[rgba(0,0,0,0.3)] rounded-lg m-5">
        <!-- group-1  -->
